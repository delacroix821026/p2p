...
public class OrderServiceFallBackFactory implements FallbackFactory<IOrderService> {
    public IOrderService create(final Throwable cause) {
        return new IOrderService() {
            ...
            public Object getOrderInfoDetailByCustomer(String openId, String orderId) {
            ...
            public Object getOrderInfoDetailByPlantManager(String orderId) {
                log.info("*********getOrderInfoDetailByPlantManager:被熔断***********");
                log.error(cause);
                return "1026";
            }

            public Object getOrderInfoByManager(String orderId) {
                log.info("*********getOrderInfoByManager:被熔断***********");
                log.error(cause);
                return "1026";
            }
